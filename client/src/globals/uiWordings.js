export default {
  ...
  'GlobalConstants.GUIDED_TALKTcLabel': 'GUIDED TALK TC',
  'GlobalConstants.GUIDED_TALKScLabel': 'GUIDED TALK SC',
  'GlobalConstants.GUIDED_TALKEnLabel': 'GUIDED TALK EN',
  'GlobalConstants.YOUTH_PROGRAMMETcLabel': 'YOUTH PROGRAMME TC',
  'GlobalConstants.YOUTH_PROGRAMMEScLabel': 'YOUTH PROGRAMME SC',
  'GlobalConstants.YOUTH_PROGRAMMEEnLabel': 'YOUTH PROGRAMME EN',
  'GlobalConstants.CANTONESE_OPERA_KNOWLEDGETcLabel':
    'CANTONESE OPERA KNOWLEDGE TC',
  'GlobalConstants.CANTONESE_OPERA_KNOWLEDGEScLabel':
    'CANTONESE OPERA KNOWLEDGE SC',
  'GlobalConstants.CANTONESE_OPERA_KNOWLEDGEEnLabel':
    'CANTONESE OPERA KNOWLEDGE EN',
  'GlobalConstants.COLLEGE_SHOWTcLabel': 'COLLEGE SHOW TC',
  'GlobalConstants.COLLEGE_SHOWScLabel': 'COLLEGE SHOW SC',
  'GlobalConstants.COLLEGE_SHOWEnLabel': 'COLLEGE SHOW EN',
