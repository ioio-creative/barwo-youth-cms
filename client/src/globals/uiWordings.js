export default {
  ...
  'GlobalConstants.LatestShowIconTcLabel': 'Latest Show Icon TC',
  'GlobalConstants.LatestShowIconScLabel': 'Latest Show Icon SC',
  'GlobalConstants.LatestShowIconEnLabel': 'Latest Show Icon EN',
  ...
  'GlobalConstants.TeamTcLabel': 'Team TC',
  'GlobalConstants.TeamScLabel': 'Team SC',
  'GlobalConstants.TeamEnLabel': 'Team EN',
  ...
  'GlobalConstants.ContactInfoTcLabel': 'ContactInfo TC',
  'GlobalConstants.ContactInfoScLabel': 'ContactInfo SC',
  'GlobalConstants.ContactInfoEnLabel': 'ContactInfo EN',
  ...
  'GlobalConstants.RESEARCH_AND_EDUCATIONTcLabel': 'RESEARCH AND EDUCATION TC',
  'GlobalConstants.RESEARCH_AND_EDUCATIONScLabel': 'RESEARCH AND EDUCATION SC',
  'GlobalConstants.RESEARCH_AND_EDUCATIONEnLabel': 'RESEARCH AND EDUCATION EN',
  'GlobalConstants.KnowledgeTcLabel': 'Knowledge TC',
  'GlobalConstants.KnowledgeScLabel': 'Knowledge SC',
  'GlobalConstants.KnowledgeEnLabel': 'Knowledge EN',
  'GlobalConstants.WorkshopTcLabel': 'Workshop TC',
  'GlobalConstants.WorkshopScLabel': 'Workshop SC',
  'GlobalConstants.WorkshopEnLabel': 'Workshop EN',
  'GlobalConstants.VideoShowTcLabel': 'Video Show TC',
  'GlobalConstants.VideoShowScLabel': 'Video Show SC',
  'GlobalConstants.VideoShowEnLabel': 'Video Show EN',
  'GlobalConstants.SharingTcLabel': 'Sharing TC',
  'GlobalConstants.SharingScLabel': 'Sharing SC',
  'GlobalConstants.SharingEnLabel': 'Sharing EN',
  'GlobalConstants.PastActivityTcLabel': 'Past Activity TC',
  'GlobalConstants.PastActivityScLabel': 'Past Activity SC',
  'GlobalConstants.PastActivityEnLabel': 'Past Activity EN',
  ...
  'GlobalConstants.BarwoScLabel': 'Barwo TC',
  'GlobalConstants.BarwoEnLabel': 'Barwo TC',
  'GlobalConstants.PlanTcLabel': 'Plan TC',
  'GlobalConstants.PlanScLabel': 'Plan TC',
  'GlobalConstants.PlanEnLabel': 'Plan TC',
  'GlobalConstants.AdminsTcLabel': 'Admins TC',
  'GlobalConstants.AdminsScLabel': 'Admins TC',
  'GlobalConstants.AdminsEnLabel': 'Admins TC',
  'GlobalConstants.OrganizerTcLabel': 'Organizer TC',
  'GlobalConstants.OrganizerScLabel': 'Organizer TC',
  'GlobalConstants.OrganizerEnLabel': 'Organizer TC',
  'GlobalConstants.SponsorTcLabel': 'Sponsor TC',
  'GlobalConstants.SponsorScLabel': 'Sponsor TC',
  'GlobalConstants.SponsorEnLabel': 'Sponsor TC',
